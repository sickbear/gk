...
urlpatterns = [
    ...
    path('newthread/<section_id>/', views.new_thread, name='forum_new_thread'),  # used
    path('newthreadpage/', views.new_thread_page, name='forum_new_thread_page'),  # used
    ...
    path('quicksearch/', views.quick_search, name='forum_quick_search'),  # used
    path('categoryinfo/', views.category_info, name='category_info'),  # used
